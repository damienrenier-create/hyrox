...
export const QUALITY_LEVELS: { code: QualityCode; label: string; value: number; color: string }[] = [
  { code: "TI", label: "Très insuffisant", value: -1, color: "text-red-600" },
  { code: "I", label: "Insuffisant", value: 0, color: "text-orange-600" },
  { code: "S", label: "Satisfaisant", value: 3, color: "text-amber-600" },
  { code: "B", label: "Bien", value: 4, color: "text-lime-700" },
  { code: "TB", label: "Très bien", value: 5, color: "text-emerald-600" },
  { code: "E", label: "Excellent", value: 6, color: "text-sky-600" },
];
