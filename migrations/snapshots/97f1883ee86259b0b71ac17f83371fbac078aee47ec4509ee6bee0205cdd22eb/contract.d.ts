...
export type StorageHash =
  StorageHashBase<'97f1883ee86259b0b71ac17f83371fbac078aee47ec4509ee6bee0205cdd22eb'>;
export type ExecutionHash =
  ExecutionHashBase<'13cce07f1b60d76bf7ca09ac64209ae36b3fe2e48901f205e919e4f782b6738d'>;
...
export namespace Models {
  ...
  export type public_Session = {
    ...
    evaluations: public_Evaluation[];
    teams: public_Team[];
    readonly [RelationKeys]?: 'boatPlacements' | 'evaluations' | 'teams';
  };
  ...
  export type public_Evaluation = {
    ...
    session: public_Session;
    team: public_Team;
    readonly [RelationKeys]?: 'evaluator' | 'session' | 'team';
  };
